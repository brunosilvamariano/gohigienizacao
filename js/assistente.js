...
class AmiltonAssistant {
    ...
    initElements() {
        ...
        widget.innerHTML = `
            <section id="botChatContainer" class="bot-chat-container" aria-hidden="true">
                <header class="bot-chat-header">
                    <div class="bot-header-info">
                        <img src="images/assistente-humano.jpg" alt="Atendimento GoClean" class="header-avatar">
                        <div>
                            <strong class="header-name">GoClean Atendimento</strong>
            ...
            <button id="botFloatingButton" class="bot-floating-btn" aria-label="Abrir chat com atendimento" aria-haspopup="true" aria-expanded="false">
            </button>
        `;
    ...
    showInitialMessage() {
        ...
        setTimeout(() => {
            ...
            this.showQuickReplies([
                ...
                { text: '🚗 Banco de Carro', value: 'Banco de Carro' },
                { text: '❓ Outro serviço', value: 'Outros' }
            ]);
        }, 800);
    }
    ...
    handleOptionSelect(text, value) {
        ...
        setTimeout(() => {
            ...
            if (value === 'Outros') {
                ...
                this.addBotMessage('Perfeito 👍\n\nMe diga o que você precisa higienizar:');
                this.showInputArea('Descreva aqui...');
            } else {
                this.goToNameStep();
            }
        }, 600);
    ...
    goToNameStep() {
        ...
        this.addBotMessage('Perfeito 👍\n\nA higienização escolhida remove sujeiras profundas, elimina ácaros e deixa tudo muito mais saudável 🧼✨\n\nAgora me diga seu **nome** para te enviar um orçamento 👇');
    ...
    showFinishStep() {
        ...
        this.inputArea.style.display = 'none';
        this.addBotMessage(`Perfeito, **${this.selectedOptions.nome}**! 🙌\n\nClique no botão abaixo para continuar seu atendimento pelo WhatsApp e receber seu orçamento.`);
        ...
        btn.innerHTML = '<i class="bi bi-whatsapp"></i> Solicitar Orçamento no WhatsApp';
    ...
    goBack() {
        ...
        if (this.currentStep === 'initial') {
            ...
            this.addBotMessage('Me diga o que você precisa higienizar:');
            this.showInputArea('Descreva aqui...');
        } else if (this.currentStep === 'name') {
            this.addBotMessage('Digite seu **nome**:');
            this.showInputArea('Digite seu nome...');
        }
    ...
    sendToWhatsApp() {
        ...
        if (tipoServico === 'Outros') {
            msg += `Gostaria de um orçamento para: ${textoOutros}. `;
        } else {
            msg += `Gostaria de um orçamento para higienização de ${tipoServico}. `;
        }
        msg += `Vim pelo site da GoClean.`;
